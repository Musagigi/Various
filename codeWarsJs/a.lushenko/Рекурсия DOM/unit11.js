...
// должна добавляь в out имена всех тегов внутри блока z1.
// Теги добавляются через пробел. Функция t1 возвращает out.
// Ожидаемый вывод для данного задания DIV P SPAN DIV B I SPAN STRONG.
function t1(elem) {
    let out = '';
    out += elem.tagName + " ";
...
// Array(elem.children).forEach(element => {
    // console.log(element);
// });
// { 0: p, 1: div, 2: span, length: 3 }
...
// Task 5
// При нажатии кнопки запускается функция t5. Функция t5, 
// с помощью рекурсивной функции r5 должна те теги внутри z-5, которые не имеют вложенных тегов заменить на теги mark. 
function t5(elem) {
    r5(elem);
